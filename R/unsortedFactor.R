...
#' 
#' @description
#' Casting \code{\link{factor}} upon a (`character`) vector usually results 
...
#' the context of visualization, e.g. when working with tiled **lattice** 
...
#' 
#' @param x A `character` vector with elements to converted to 
#' \code{factor}. 
